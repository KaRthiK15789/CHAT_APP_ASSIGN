...
export default function MessageInput({ chatId, currentUser }: MessageInputProps) {
    ...
    <div className="border-t border-gray-200 bg-white p-4">
      ...
      <div className="flex items-end space-x-3">
        ...
        <div className="relative">
          ...
          >
            <div className={`w-3 h-3 rounded-full ${getSelectedAccountInfo().color}`}></div>
      ...
      <div className="mt-2 h-4">
        {/* This would show typing indicators in a real app */}
